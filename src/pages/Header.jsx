...
const Header = () => {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto overflow-hidden rounded-md pt-20">
      ...
      <button
        onClick={prevSlide}
        className="absolute top-1/2 left-2 transform -translate-y-1/2 text-white px-3 py-2 rounded-fulltransition"
      >
        <span>
      ...
      <button
        onClick={nextSlide}
        className="absolute top-1/2 right-2 transform -translate-y-1/2 text-white px-3 py-2 rounded-full transition"
      >
        <span>
